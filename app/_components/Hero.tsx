        ...
        <Section className='flex flex-col gap-2'>
            ...
            <div>
                ...
                <p className="text-base md:hidden md:text-justify mt-1">
                    Je recherche une <strong className='text-primary'>alternance de 15 mois</strong> en Conception et Développement d&apos;Applications &#40;formation Bac+3&#41;, je suis ultra motivée à rejoindre une équipe qui allie travail de qualité et bonne ambiance !
                </p>
