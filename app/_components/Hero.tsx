...
export const Hero = () => {
    return (
        <Section className="flex justify-center max-md:flex-col items-center content-center">
            ...
            <div className="flex-1 w-full max-w-[200px] md:max-w-[250px] lg:max-w-[300px] mt-6 lg:mt-0 flex justify-center content-center">
                <Image
